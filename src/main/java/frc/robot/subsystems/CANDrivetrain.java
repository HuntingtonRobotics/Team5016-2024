...
public class CANDrivetrain extends SubsystemBase {
  ...
  public CANDrivetrain() {
    ...
    var leftFront = new WPI_TalonSRX(kLeftFrontID);
    var leftRear = new WPI_TalonSRX(kLeftRearID);
    var rightFront = new WPI_TalonSRX(kRightFrontID);
    var rightRear = new WPI_TalonSRX(kRightRearID);
